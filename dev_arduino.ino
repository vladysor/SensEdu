...
#define STORE_BUF_SIZE 		7200    // 2400 for 1 measurement per second. 
...
// send serial data in 32byte chunks
void serial_send_array(const uint8_t* data, size_t size) {
    const size_t chunk_size = 32; // buffer is 64 bytes, but 32 for 2400 data samples
