...
if (REAL_MEASUREMENTS == true)
    % do this step if you didn't do outlier rejection in data_acquisition.m
    % dist_outliers = dist_matrix;
    % dist_matrix = outlier_rejection(dist_matrix);
    dist_matrix= dist_matrix_or;
    pos_init_estimate = [-0.105; 0.005; 0.35];
...
plot_trajectory(state_history, microphones, REAL_MEASUREMENTS, pos_init_estimate);
